 ...
 */
function model_jsonSchema(fields, populate, readonly, options) {
  var jsonSchema = this.schema.jsonSchema(this.modelName);
  var removeRequired = options && options.removeRequired;
  ...
  if (fields && removeRequired) __removeRequired(jsonSchema);
